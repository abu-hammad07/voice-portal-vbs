...
<head>
    ...
    <title>Voice Portal Dashboard</title>
    <!-- Google font-->
                        ...
                        <ul class="nav-menus">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="toast-body d-flex p-0">
                                                    <div class="flex-shrink-0 bg-light-primary"><img class="w-auto"
                                                            ...
                                                            alt="Wallet"></div>
                                                    <div class="flex-grow-1"> <a href="private-chat">
                            ...
                            <li class="profile-nav onhover-dropdown px-0 py-0">
                                <div class="d-flex profile-media align-items-center"><img class="img-30"
                                    ...
                                    <div class="flex-grow-1"><span>Aisha</span>
                                ...
                                <ul class="profile-dropdown onhover-show-div">
                                    ...
                                    <li><a href="letter-box"><i data-feather="mail"></i><span>Inbox</span></a></li>
                                    <li><a href="task"><i data-feather="file-text"></i><span>Taskboard</span></a>
                                    </li>
                                    <li><a href="edit-profile"><i data-feather="settings"></i><span>Settings</span></a>
                                    </li>
                                    <li><a href="login"><i data-feather="log-in"> </i><span>Log out</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
