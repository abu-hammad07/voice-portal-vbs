                        ...
                        <form class="row g-3 needs-validation custom-input" novalidate="">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input class="form-control" id="validationCustom02" type="text"
                                    placeholder="Enter product masking" required>
                                <div class="invalid-feedback">Please enter your valid </div>
                                <div class="valid-feedback">
                                    Looks's Good!</div>
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <input class="form-control" id="validationCustom03" type="text"
                                    placeholder="Enter Product shortcode" required>
                                <div class="invalid-feedback">Please enter your valid</div>
                                <div class="valid-feedback">
                                    Looks's Good!</div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <textarea name="" class="form-control" rows="3" id="validationCustom07"
                                    placeholder="Enter product Summary" required></textarea>
                                <div class="invalid-feedback">Please enter your valid</div>
                                <div class="valid-feedback">
                                    Looks's Good!</div>
                            </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="btn-group">
                                    <button class="btn btn-primary me-2" type="submit">Add Product</button>
